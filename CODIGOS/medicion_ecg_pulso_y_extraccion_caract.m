...
%% 
% Nota: Antes de correr las siguientes lineas de codigo importar la señal
% de GSR generada por el código "adquisicion_senal_gsr"
GSRraw = load('JhonDGSR.mat');  % Cargar archivo GSR.mat con señal de GSR y tiempo
GSR = GSRraw.voltaje;

signal = dataraw;   %señal del ECG
signal1 = dataraw1; %señal de pulso 
